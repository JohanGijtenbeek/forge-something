  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-gray-900">Leveranciers</h1>
          <p className="text-sm text-gray-500 mt-0.5">{filtered?.length ?? 0} leveranciers</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        ...
        {filtered?.length === 0 && (
          <div className="px-4 py-8 text-center text-sm text-gray-500">Geen leveranciers gevonden.</div>
        )}
      </div>
    </div>
  );
